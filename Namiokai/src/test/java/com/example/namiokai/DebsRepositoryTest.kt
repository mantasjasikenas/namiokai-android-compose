...
class DebsRepositoryTest {
    ...
    fun setup() {
        bills = mutableListOf(
            ...
            Bill(paymasterUid = sigisUser, total = 15.0, splitUsersUid = listOf(sigisUser, mantelisUser)),
            Bill(paymasterUid = sigisUser, total = 15.0, splitUsersUid = listOf(mantelisUser)),
            Bill(paymasterUid = mantelisUser, total = 15.0, splitUsersUid = listOf(sigisUser, mantelisUser)),
        )
    }
