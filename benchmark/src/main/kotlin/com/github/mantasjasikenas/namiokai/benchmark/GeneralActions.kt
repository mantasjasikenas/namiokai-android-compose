package com.github.mantasjasikenas.namiokai.benchmark
...
/**
 * Waits for and returns the `namiokaiTopAppBar`
 */
fun MacrobenchmarkScope.getTopAppBar(): UiObject2 {
    device.wait(Until.hasObject(By.res("namiokaiTopAppBar")), 2_000)
    return device.findObject(By.res("namiokaiTopAppBar"))
}
